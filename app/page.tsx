    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="sticky top-0 z-40 border-b border-gray-100 bg-white/80 backdrop-blur">
        <div className="max-w-6xl mx-auto px-6 flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/register" className="text-sm bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium transition">
              Get Started Free
            </Link>
          </div>
        </div>
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 py-24 bg-gradient-to-b from-orange-50 to-white">
        ...
        <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight max-w-3xl mb-6">
          Online ordering,<br />
          <span className="text-orange-500">built for restaurants</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/register"
            className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-4 rounded-xl text-lg transition shadow-lg shadow-orange-200"
          >
            Start Restaurant Setup <ChevronRight size={20} />
          </Link>
          <Link
            href="/restaurant/demo-sushi-house"
            className="flex items-center gap-2 border-2 border-gray-200 hover:border-orange-300 text-gray-700 font-semibold px-8 py-4 rounded-xl text-lg transition"
          >
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map(f => (
              <div key={f.title} className="p-6 rounded-2xl border border-gray-100 hover:border-orange-200 hover:shadow-md transition group">
                <div className="w-12 h-12 bg-orange-100 group-hover:bg-orange-500 rounded-xl flex items-center justify-center mb-4 transition">
                  <f.icon size={22} className="text-orange-500 group-hover:text-white transition" />
                </div>
      ...
      <section className="py-20 px-6 bg-orange-500">
        <div className="max-w-2xl mx-auto text-center text-white">
          ...
          <p className="text-orange-100 mb-8 text-lg">Join restaurants already using OrderFlow to grow their business.</p>
          <Link
            href="/register"
            className="inline-flex items-center gap-2 bg-white text-orange-500 font-semibold px-8 py-4 rounded-xl text-lg hover:bg-orange-50 transition"
          >
      ...
      <footer className="border-t border-gray-100 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-700">OrderFlow</span>
          </div>
          <p>© {new Date().getFullYear()} OrderFlow. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
